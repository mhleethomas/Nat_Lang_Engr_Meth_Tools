...
- Split sizes: 20,000 train / 10,000 validation / 10,000 test
...
- CRF (best on validation):
	...
	- Test Precision/Recall/F1: 0.7198 / 0.6977 / 0.7086
- BiLSTM (best on validation):
	- Validation F1: 0.4678
	- Test Precision/Recall/F1: 0.4222 / 0.5080 / 0.4611

Error Analysis
- Common error patterns:
	- ORG vs PER and ORG vs LOC confusions on entity names
	- Boundary errors on multi-token entities
	- Tokens inside ORG spans predicted as O (span fragmentation)
